            ...
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <h1 className="text-3xl font-semibold text-[#0F172A]">
                  Join modern teams shipping fintech faster
                </h1>
                <p className="text-[#4B5563]">
                  Spin up a secure workspace, invite your team, and start
                  building compliant banking, payments, or lending flows in
                  days.
                </p>
              </div>
              ...
              <div className="grid gap-4">
                <div className="rounded-2xl border border-[#E5E7EB] bg-[#F8FAFC] p-4">
                  ...
                  <p className="text-sm text-[#4B5563] mt-1">
                    Bank-grade security, audit trails, and granular roles from
                    day one.
                  </p>
                </div>
                <div className="rounded-2xl border border-[#E5E7EB] bg-[#F8FAFC] p-4">
                  ...
                  <p className="text-sm text-[#4B5563] mt-1">
                    Payments, onboarding, risk controls, and KYC you can ship
                    quickly.
                  </p>
                </div>
              </div>
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="space-y-4">
                ...
                <label className="flex items-start gap-2 text-sm text-[#4B5563]">
                  ...
                  <span>
                    I agree to the{" "}
                    <Link to="/terms" className="text-[#1F6FEB] underline">
                      Terms
                    </Link>{" "}
                    and{" "}
                    <Link to="/privacy" className="text-[#1F6FEB] underline">
                      Privacy Policy
                    </Link>
                    .
                  </span>
              ...
              <div className="rounded-2xl border border-[#E5E7EB] bg-[#F8FAFC] p-4 text-sm text-[#4B5563]">
                ...
                <p className="mt-2">
                  Encrypted data at rest and in transit, role-based access
                  control, and continuous monitoring to keep your workspace
                  safe.
                </p>
              </div>
            </form>
