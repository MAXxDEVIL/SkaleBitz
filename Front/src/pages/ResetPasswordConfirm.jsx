...
export default function ResetPasswordConfirm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setStatus(
        data?.message || "Password updated successfully. You can log in now."
      );
          ...
          <div className="relative rounded-3xl border border-[#E5E7EB] bg-white p-10 shadow-2xl shadow-[#E0E7FF] space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-[#4B5563]">
                Enter and confirm your new password. The link works for a
                limited time to keep your account secure.
              </p>
            </div>
