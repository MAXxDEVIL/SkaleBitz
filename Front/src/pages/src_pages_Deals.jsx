...
import { deriveLocation, getStatusMeta, normalizeStatus, resolveTenorMonths } from '../utils/dealMeta';
...
export default function Deals() {
  ...
  const filteredDeals = useMemo(() => {
    ...
    if (region !== 'All') {
      ...
      list = list.filter((d) => deriveLocation(d).toLowerCase() === regionFilter);
    }
    if (minYield) {
