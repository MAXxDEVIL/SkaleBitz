        ...
        <div className="relative w-full max-w-4xl">
          ...
          <div className="relative rounded-3xl border border-[#E5E7EB] bg-white p-10 shadow-2xl shadow-[#E0E7FF] space-y-4">
            ...
            <p className="text-[#4B5563] text-sm leading-relaxed">
              These Terms govern access to the SkaleBitz platform. By using the
              product you agree to our acceptable use, security, and privacy
              practices. Replace this copy with your legal language when ready.
            </p>
