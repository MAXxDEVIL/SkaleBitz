...
export default function RiskReports() {
  const alerts = [
    {
      title: "Exposure guardrail",
      detail: "Retail bundle at 74% of limit",
      severity: "medium",
    },
    {
      title: "Payout velocity",
      detail: "Payouts +12% vs baseline this week",
      severity: "low",
    },
    {
      title: "Fraud monitoring",
      detail: "No new fraud flags in last 24h",
      severity: "info",
    },
  ];
      ...
      <Container className="flex flex-col gap-8 py-10">
        <header className="flex flex-col gap-2">
          ...
          <p className="text-sm text-[#4B5563]">
            Guardrails, alerts, and portfolio risk posture.
          </p>
        </header>
